...
$query = $conexion->prepare("SELECT titulo, descripcion, categoria_nombre, categoria_id, precio, descuento, tipo FROM productos 
WHERE id= :id");
$query->execute(['id'=> $id]);
        ...
        <div class="col">
            <form class="row g-3" action="guarda.php" method="post" autocomplete="off" enctype="multipart/form-data">
                ...
                <div class="col-md-4">
                    ...
                    value="<?php echo $row['titulo']; ?>" required autofocus>
                </div>
                ...
                <div class="col-md-6">
                    ...
                    value="<?php echo $row['descuento']; ?>" required>
                </div>
                <div class="col-md-6">
    <label for="tipo" class="form-label">Tipo de Producto</label>
    <select id="tipo" name="tipo" class="form-control" value="<?php echo $row['tipo']; ?>" required>
